 ...
 *   - personal docs under `users/amllamojha/authored/personal/`.
 */
...
export function defaultSeed(): Seed {
  return {
    ...
    'users/amllamojha/authored/personal/q2-planning.md': personalNoteMd,
    'users/amllamojha/authored/personal/ideas.md': personalIdeasMd,

    'users/amllamojha/_system/structure.json': JSON.stringify(STRUCTURE, null, 2),
  };
}
