...
`pnpm --filter @vaultmark/web typecheck` + web build; curate Lambda `tsc` + `npm test`; new unit tests for schema/validator/migration and the multi-space routes. Clean up any temp files. No commits/pushes unless the user asks.
