...
Canopy turns it into a searchable knowledge portal, while docs stay where they belong, in S3.
...
Canopy: portable docs, searchable knowledge, and AI assisted work.`;
